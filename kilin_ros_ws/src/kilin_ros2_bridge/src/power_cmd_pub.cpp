...
int main(int argc, char *argv[])
{
    ...
    bool clean = false, trigger = false, steering_cali = false;
    ...
    {
        std::string line;
        std::cout << "Enter command (e.g. P D 1 or P C 0): ";
        ...
        RCLCPP_INFO(node->get_logger(),
            "Published PowerCmd: D=%d S=%d P=%d C=%d T=%d A=%d",
            msg.digital, msg.signal, msg.power, msg.clean, msg.trigger, msg.steering_cali);
